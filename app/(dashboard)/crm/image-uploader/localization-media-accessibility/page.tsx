...
export default function LocalizationImageAdminPage() {
  const API_BASE = process.env.NEXT_PUBLIC_API_BASE_URL || "";
  const CONTENT_PATH = "/api/v1/content/localization";
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (alive)
          setErr(e?.message || "Failed to load localization content");
      } finally {
  ...
  return (
    <div className="p-6">
      ...
      <SectionHeader
        title="Localization & Media Accessibility – Images"

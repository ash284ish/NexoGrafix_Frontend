...
export default function ContentEdTechImageAdminPage() {
  const API_BASE = process.env.NEXT_PUBLIC_API_BASE_URL || "";
  const CONTENT_PATH = "/api/v1/content/elearning";
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (alive)
          setErr(e?.message || "Failed to load content & edtech data");
      } finally {
  ...
  return (
    <div className="p-6">
      ...
      <SectionHeader
        title="Content, eLearning & EdTech – Images"

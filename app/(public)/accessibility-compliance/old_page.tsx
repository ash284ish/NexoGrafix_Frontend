    ...
    <motion.section variants={pageWrap} initial="hidden" animate="show" className="relative overflow-hidden bg-white">
      ...
      <div className="relative mx-auto max-w-[80rem] px-7 py-14 sm:px-8 sm:py-20">
        <ServiceHeroSection
          ...
          chips={[
            { icon: <FiShield className="text-[var(--color-brand-dark)]" />, text: "Standards-led compliance delivery" },
            { icon: <FiBarChart2 className="text-[var(--color-brand-dark)]" />, text: "Clear reporting & validation" },
          ]}
          pills={pills}
          badges={[
            <>

    ...
    <motion.section variants={pageWrap} initial="hidden" animate="show" className="relative overflow-hidden bg-white">
      ...
      <div className="relative mx-auto max-w-7xl px-7 py-14 sm:px-8 sm:py-20">
        <ServiceHeroSection
          ...
          chips={[
            { icon: <FiShield className="text-(--color-brand-dark)" />, text: "Secure, scalable engineering" },
            { icon: <FiBarChart2 className="text-(--color-brand-dark)" />, text: "Performance-first delivery" },
          ]}
          pills={pills}
          badges={[
            <>

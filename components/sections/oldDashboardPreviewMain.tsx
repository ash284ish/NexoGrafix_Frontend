...
function NavSubItem({
    ...
    return (
        <button
            onClick={onClick}
            className={`flex w-full items-center gap-2 rounded-md px-3 py-2 text-left text-[13px] transition ${active
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="col-span-12 space-y-6 lg:col-span-8">
                    <div className="rounded-md border border-slate-200 bg-white p-6 shadow-sm">
                        <div className="flex items-start justify-between">
                            <div>
                                <div className="text-md font-semibold text-slate-900">Credits Overview</div>
                                <div className="mt-1 text-sm text-slate-500">Remaining Credits</div>
                            </div>
                    ...
                    <div className="rounded-md border border-slate-200 bg-white p-6 shadow-sm">
                        <div>
                            <div className="text-md font-semibold text-slate-900">Analytics Snapshot</div>
                        ...
                        <div className="mt-6 rounded-md bg-slate-50 p-4">
                            <svg viewBox="0 0 500 160" className="h-[180px] w-full">
                                ...
                                {[110, 90, 40, 70, 50].map((y, i) => (
                                    <circle key={i} cx={i * 100} cy={y} r="4" fill="#14b8a6" />
                                ))}
                            </svg>
                ...
                <div className="col-span-12 space-y-6 lg:col-span-4">
                    <div className="rounded-md border border-slate-200 bg-white p-6 shadow-sm">
                        <div className="text-md font-semibold text-slate-900">Notifications</div>
                    ...
                    <div className="rounded-md border border-slate-200 bg-white p-6 shadow-sm">
                        <div className="text-md font-semibold text-slate-900">Quick Actions</div>
            ...
            <div className="rounded-md border border-emerald-200 bg-white p-6 shadow-sm">
                <div className="flex items-center gap-6">
                    ...
                    <div className="flex-1">
                        <div className="text-sm font-medium text-slate-600">Productivity gain</div>
                        <div className="mt-1 text-3xl font-semibold text-slate-900">10 hours saved</div>
                ...
                <aside className="col-span-12 space-y-6 lg:col-span-4">
                    ...
                    <div className="rounded-md border border-emerald-200 bg-white p-6 shadow-sm">
                        ...
                        <div className="mt-2 text-sm text-slate-600">
                            You’ll see extracted images grouped by PDF pages. Select only meaningful images for alt-text
                            generation.
                        </div>
                        ...
                        <div className="flex items-start justify-between gap-3">
                            <div>
                                ...
                                <div className="mt-1 text-sm text-slate-600">
                                    You have selected{" "}
                                    <span className="font-semibold text-slate-900">{selectedCount}</span> image(s) for alt-text
                                    generation.
                                </div>
                            </div>
...
export function AltTextEditorPage() {
    ...
    const [text, setText] = React.useState("A close-up of a laptop screen showing analytics dashboards.");
...
export function ReviewApprovalPage() {
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-start justify-between">
                <div>
                    <h1 className="text-2xl font-semibold text-slate-900">Review & approval</h1>
                    <p className="mt-1 text-sm text-slate-600">
            ...
            <div className="rounded-md bg-white p-6 shadow-sm ring-1 ring-slate-200">
                <div className="flex items-start justify-between gap-4">
                    <div>
                        ...
                        <div className="mt-1 text-xs text-slate-500">Progress based on approved alt text items</div>
                    </div>
                ...
                <div className="mt-5 grid grid-cols-3 gap-6 text-sm">
                    ...
                    <div>
                        ...
                        <div className="mt-1 text-lg font-semibold text-emerald-700">21</div>
                    </div>
                </div>
                ...
                {roles.map((r) => (
                    ...
                    >
                        <div className="flex items-start justify-between gap-3">
                            ...
                            <span
                                className={["rounded-full px-3 py-1 text-xs font-semibold ring-1", r.statusClass].join(
                                    " "
                                )}
                            >
                                {r.status}
    ...
    return (
        <div className="space-y-8">
            <div className="space-y-2 text-center">
                <h1 className="text-2xl font-semibold text-slate-900">Export results</h1>
...
function ProjectsPage() {
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-start justify-between">
                <div>
                    <h1 className="text-2xl font-semibold text-slate-900">Projects &amp; Folders</h1>
                    <p className="mt-1 text-sm text-slate-600">
            ...
            <div className="text-sm text-slate-500">
                Projects &nbsp;›&nbsp; <span className="font-medium text-slate-900">Marketing Campaign 2024</span>
            </div>
            ...
            <div className="grid grid-cols-12 gap-6">
                    ...
                    <div className="space-y-4">
                        {files.map((f) => (
                            ...
                            >
                                ...
                                <div className="flex items-center gap-3">
                                    <span className={`rounded-full border px-3 py-1 text-xs font-medium ${f.statusClass}`}>
                                        {f.status}
                                    </span>
                ...
                <div className="col-span-12 rounded-md border border-slate-200 bg-white p-6 shadow-sm lg:col-span-4">
                    <div className="text-lg font-semibold text-slate-900">Folder Info</div>
                    ...
                    <div className="mt-4 space-y-4 text-sm">
                        ...
                        <div>
                            ...
                            <div className="mt-1 rounded-md border border-slate-100 p-3">January 15, 2024</div>
                        </div>

...
function CertImage({ c, size }: { c: FooterJson["certifications"][number]; size: "sm" | "lg" }) {
    ...
    return (
        <div
            className={`flex items-center justify-center rounded-md border border-slate-600/50 bg-slate-800 text-xs font-bold text-slate-400 ${size === "lg" ? "h-12 w-28" : "h-8 w-20"
                }`}
        >
            {c.alt}
        </div>

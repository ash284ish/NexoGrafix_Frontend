    ...
    () => [
      {
        ...
        label: "Dashboard",
        href: "/dashboard",
        icon: <FiGrid className="h-[18px] w-[18px]" />,
      },
...

      {
        ...
        children: [
          { label: "Home", href: "/crm/home", icon: <FiHome className="h-[18px] w-[18px]" /> },
          { label: "ArohioPreview", href: "/crm/dashboard-preview", icon: <FiLayers className="h-[18px] w-[18px]" /> },
          { label: "About Us", href: "/crm/about", icon: <FiInfo className="h-[18px] w-[18px]" /> },
          { label: "Contact Us", href: "/crm/contact-us", icon: <FiPhoneCall className="h-[18px] w-[18px]" /> },
          { label: "Feedback", href: "/crm/feedback", icon: <FiMessageSquare className="h-[18px] w-[18px]" /> },
          { label: "FAQs", href: "/crm/faqs", icon: <FiHelpCircle className="h-[18px] w-[18px]" /> },
          { label: "Blog", href: "/crm/blog", icon: <FiFileText className="h-[18px] w-[18px]" /> },
          { label: "Blog Details", href: "/crm/blog-details", icon: <FiFileText className="h-[18px] w-[18px]" /> },
        ],
      },

      {
        ...
        children: [
          { label: "Header", href: "/crm/header", icon: <FiLayout className="h-[18px] w-[18px]" /> },
          { label: "Footer", href: "/crm/footer", icon: <FiSidebar className="h-[18px] w-[18px]" /> },
        ],
      },

      {
        ...
        children: [
          { label: "Terms & Conditions", href: "/crm/terms", icon: <FiFileText className="h-[18px] w-[18px]" /> },
          { label: "Privacy Policy", href: "/crm/privacy-policy", icon: <FiFileText className="h-[18px] w-[18px]" /> },
          { label: "Refund Policy", href: "/crm/refund-policy", icon: <FiFileText className="h-[18px] w-[18px]" /> },
        ],
      },

      {
        ...
        children: [
          { label: "Arohio", href: "/crm/arohio", icon: <FiLayers className="h-[18px] w-[18px]" /> },
        ],
      },

      {
        ...
        icon: <FiLayers className="h-[18px] w-[18px]" />,
        children: [
          { label: "Publishing & Digitization", href: "/crm/publishingneww", icon: <FiBookOpen className="h-[18px] w-[18px]" /> },
          { label: "Accessibility & Compliance", href: "/crm/accessibility", icon: <FiHelpCircle className="h-[18px] w-[18px]" /> },
          { label: "IT & Digital Platforms", href: "/crm/it", icon: <FiCode className="h-[18px] w-[18px]" /> },
          { label: "Data Labeling & Annotation", href: "/crm/data-labeling", icon: <FiLayers className="h-[18px] w-[18px]" /> },
          { label: "Localization & Media Accessibility", href: "/crm/localization", icon: <FiHeadphones className="h-[18px] w-[18px]" /> },
          { label: "Content, eLearning & EdTech", href: "/crm/elearning", icon: <FiBookOpen className="h-[18px] w-[18px]" /> },
        ],
      },
              ...
              <AnimatePresence>
                {userOpen && (
                  <motion.div
                    ...
                    exit={{ opacity: 0, y: 10 }}
                    className="absolute right-0 mt-2 w-[240px] overflow-hidden rounded-md border border-black/10 bg-white shadow-[0_18px_50px_-30px_rgba(0,0,0,0.45)]"
                  >
        ...
        {showProfile && (
          ...
          >
            <motion.div
              ...
              className="w-[94vw] max-w-[420px] overflow-hidden rounded-md border border-white/20 bg-white shadow-[0_30px_70px_-35px_rgba(0,0,0,0.55)]"
            >
              <div className="relative border-b border-black/5 bg-gradient-to-b from-slate-50 to-white px-6 py-5">
                <button
                  type="button"
      ...
      <AnimatePresence>
        {toast.open && (
          <motion.div
            ...
            className="fixed right-4 top-4 z-[60] w-[92vw] max-w-[360px]"
          >
            <div
              className={cx(
        ...
        {loggingOut && (
          ...
          >
            <motion.div
              ...
              className="w-[280px] rounded-md border border-white/20 bg-white px-6 py-4 shadow-[0_20px_60px_-25px_rgba(0,0,0,0.45)]"
            >
              ...
              <div className="mt-3 h-[4px] w-full overflow-hidden rounded-full bg-slate-200">
                <motion.div
                  initial={{ x: "-100%" }}
                  animate={{ x: "0%" }}
        ...
        {mobileNavOpen && (
          ...
          >
            <motion.aside
              ...
              className="h-full w-[260px] bg-white shadow-xl flex flex-col"
            >
              {/* Header */}
